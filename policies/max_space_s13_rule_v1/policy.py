...
class PolicyClass(MaxSpaceRulePolicy):
    """Stable adapter for max_space_s13_rule_v1 (S13)."""

    PACKAGE_SPEC = {'policy_id': 'max_space_s13_rule_v1',
 'scenario_id': 'S13',
 'dimension': 2,
 ...
 'primary_metric': 'team_capture_rate',
 ...
 'default_config': {'strategy': 'pursuit_role',
                    'policy_id': 'max_space_s13_rule_v1',
                    'gain': 1.0,
                    'damping': 0.55,
                    'action_cap': 1.0,
                    'rate_limit': 2.0,
...
POLICY_SPEC = {'policy_id': 'max_space_s13_rule_v1',
 'scenario_id': 'S13',
 'dimension': 2,
 'method_name': 'role_aware_pursuit_rule',
 'strategy': 'pursuit_role',
