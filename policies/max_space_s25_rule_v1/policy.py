...
class PolicyClass(MaxSpaceRulePolicy):
    """Stable adapter for max_space_s25_rule_v1 (S25)."""

    PACKAGE_SPEC = {'policy_id': 'max_space_s25_rule_v1',
 'scenario_id': 'S25',
 'dimension': 3,
 ...
 'primary_metric': 'full_mission_completion_rate',
 ...
 'default_config': {'strategy': 'escort_defense',
                    'policy_id': 'max_space_s25_rule_v1',
                    'gain': 1.0,
                    'damping': 0.55,
                    'action_cap': 1.0,
                    'rate_limit': 2.0,
...
POLICY_SPEC = {'policy_id': 'max_space_s25_rule_v1',
 'scenario_id': 'S25',
 'dimension': 3,
 'method_name': 'role_aware_escort_defense_rule',
 'strategy': 'escort_defense',
