...
class PolicyClass(MaxSpaceRulePolicy):
    """Stable adapter for max_space_s26_rule_v1 (S26)."""

    PACKAGE_SPEC = {'policy_id': 'max_space_s26_rule_v1',
 'scenario_id': 'S26',
 'dimension': 2,
 ...
 'primary_metric': 'target_track_fraction',
 ...
 'default_config': {'strategy': 'observation_limited',
                    'policy_id': 'max_space_s26_rule_v1',
                    'gain': 1.0,
                    'damping': 0.55,
                    'action_cap': 0.82,
                    'rate_limit': 2.0,
...
POLICY_SPEC = {'policy_id': 'max_space_s26_rule_v1',
 'scenario_id': 'S26',
 'dimension': 2,
 'method_name': 'observation_limited_rule',
 'strategy': 'observation_limited',
