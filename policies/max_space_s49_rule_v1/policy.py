...
class PolicyClass(MaxSpaceRulePolicy):
    """Stable adapter for max_space_s49_rule_v1 (S49)."""

    PACKAGE_SPEC = {'policy_id': 'max_space_s49_rule_v1',
 'scenario_id': 'S49',
 'dimension': 2,
 ...
 'primary_metric': 'vision_navigation_success_rate',
 ...
 'default_config': {'strategy': 'scalable_adapter',
                    'policy_id': 'max_space_s49_rule_v1',
                    'gain': 1.0,
                    'damping': 0.55,
                    'action_cap': 0.92,
                    'rate_limit': 2.0,
 ...
 'checkpoint_binding': {'method': 'scalable_modality_rule',
                        'observation_contract': 'scenario.observation_space:image',
...
POLICY_SPEC = {'policy_id': 'max_space_s49_rule_v1',
 'scenario_id': 'S49',
 'dimension': 2,
 'method_name': 'scalable_modality_rule',
 'strategy': 'scalable_adapter',
