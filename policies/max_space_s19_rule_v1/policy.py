...
class PolicyClass(MaxSpaceRulePolicy):
    """Stable adapter for max_space_s19_rule_v1 (S19)."""

    PACKAGE_SPEC = {'policy_id': 'max_space_s19_rule_v1',
 'scenario_id': 'S19',
 'dimension': 2,
 ...
 'primary_metric': 'feasible_task_value_ratio',
 ...
 'default_config': {'strategy': 'team_coordination',
                    'policy_id': 'max_space_s19_rule_v1',
                    'gain': 1.0,
                    'damping': 0.55,
                    'action_cap': 1.0,
                    'rate_limit': 2.0,
...
POLICY_SPEC = {'policy_id': 'max_space_s19_rule_v1',
 'scenario_id': 'S19',
 'dimension': 2,
 'method_name': 'decentralized_team_rule',
 'strategy': 'team_coordination',
