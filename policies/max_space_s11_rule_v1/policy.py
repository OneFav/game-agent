...
class PolicyClass(MaxSpaceRulePolicy):
    """Stable adapter for max_space_s11_rule_v1 (S11)."""

    PACKAGE_SPEC = {'policy_id': 'max_space_s11_rule_v1',
 'scenario_id': 'S11',
 'dimension': 2,
 ...
 'default_config': {'strategy': 'pursuit_role',
                    'policy_id': 'max_space_s11_rule_v1',
                    'gain': 1.0,
                    'damping': 0.55,
                    'action_cap': 1.0,
                    'rate_limit': 2.0,
...
POLICY_SPEC = {'policy_id': 'max_space_s11_rule_v1',
 'scenario_id': 'S11',
 'dimension': 2,
 'method_name': 'role_aware_pursuit_rule',
 'strategy': 'pursuit_role',
