...
class PolicyClass(MaxSpaceRulePolicy):
    """Stable adapter for max_space_s39_rule_v1 (S39)."""

    PACKAGE_SPEC = {'policy_id': 'max_space_s39_rule_v1',
 'scenario_id': 'S39',
 'dimension': 3,
 ...
 'primary_metric': 'wind_robust_gate_completion_rate',
 ...
 'default_config': {'strategy': 'robust_capped',
                    'policy_id': 'max_space_s39_rule_v1',
                    'gain': 1.0,
                    'damping': 0.55,
                    'action_cap': 0.88,
                    'rate_limit': 2.0,
...
POLICY_SPEC = {'policy_id': 'max_space_s39_rule_v1',
 'scenario_id': 'S39',
 'dimension': 3,
 'method_name': 'robust_capped_pd_rule',
 'strategy': 'robust_capped',
