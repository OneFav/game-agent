...
class PolicyClass(MaxSpaceRulePolicy):
    """Stable adapter for max_space_s04_rule_v1 (S04)."""

    PACKAGE_SPEC = {'policy_id': 'max_space_s04_rule_v1',
 'scenario_id': 'S04',
 'dimension': 3,
 ...
 'primary_metric': 'rendezvous_success_rate',
 ...
 'default_config': {'strategy': 'goal_vector',
                    'policy_id': 'max_space_s04_rule_v1',
                    'gain': 1.0,
                    'damping': 0.55,
                    'action_cap': 1.0,
                    'rate_limit': 2.0,
...
POLICY_SPEC = {'policy_id': 'max_space_s04_rule_v1',
 'scenario_id': 'S04',
 'dimension': 3,
 'method_name': 'bounded_goal_vector_rule',
 'strategy': 'goal_vector',
