...
class RedPolicy:
    """Frozen baseline red-side behavior and parameters only."""
...
class BluePolicy:
    """Round-2 blue-side best response behavior and parameters only."""
...
class VerticalWaveRulePolicy(Policy):
    ...
    def get_config_schema(self) -> dict[str, Any]:
        return {
            ...
            "blue_risk_margin": {"type": "number", "minimum": 0.1, "maximum": 2.0, "default": 1.2},
