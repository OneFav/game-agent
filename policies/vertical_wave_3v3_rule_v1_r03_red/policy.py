...
DEFAULT_CONFIG: dict[str, Any] = {
    "red_desired_speed": 7.0,
    "blue_desired_speed": 6.6,
    "shared_position_gain": 1.3,
    "shared_velocity_gain": 2.2,
    "red_risk_margin": 0.8,
    "blue_risk_margin": 1.0,
...
class RedPolicy:
    """Round-3 red-side best-response behavior and parameters only."""
...
class BluePolicy:
    """Frozen Round-2 blue-side opponent behavior and parameters only."""
...
class VerticalWaveRulePolicy(Policy):
    ...
    def get_config_schema(self) -> dict[str, Any]:
        return {
            "red_desired_speed": {"type": "number", "minimum": 2.0, "maximum": 8.0, "default": 7.0},
            "blue_desired_speed": {"type": "number", "minimum": 2.0, "maximum": 8.0, "default": 6.6},
            ...
            "red_risk_margin": {"type": "number", "minimum": 0.1, "maximum": 2.0, "default": 0.8},
            "blue_risk_margin": {"type": "number", "minimum": 0.1, "maximum": 2.0, "default": 1.0},
            ...
            "red_lane_spacing": {"type": "number", "minimum": 0.6, "maximum": 2.2, "default": 1.6},
            "blue_lane_spacing": {"type": "number", "minimum": 0.6, "maximum": 2.2, "default": 1.6},
...
def _apply_red_inter_team_buffer(env: Any, actions: dict[int, np.ndarray], config: dict[str, Any]) -> dict[int, np.ndarray]:
    """Add a red-only avoidance buffer for late inter-team crossing conflicts."""
    ...
    for drone in env.drones:
        ...
        for other in env.drones:
            if getattr(other.team, "name", "").lower() == "red":
                continue
