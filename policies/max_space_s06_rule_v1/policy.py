...
class PolicyClass(MaxSpaceRulePolicy):
    """Stable adapter for max_space_s06_rule_v1 (S06)."""

    PACKAGE_SPEC = {'policy_id': 'max_space_s06_rule_v1',
 'scenario_id': 'S06',
 'dimension': 2,
 ...
 'primary_metric': 'energy_adjusted_success',
 ...
 'default_config': {'strategy': 'dynamics_pd',
                    'policy_id': 'max_space_s06_rule_v1',
                    'gain': 1.0,
                    'damping': 0.0,
                    'action_cap': 1.0,
                    'rate_limit': 2.0,
...
POLICY_SPEC = {'policy_id': 'max_space_s06_rule_v1',
 'scenario_id': 'S06',
 'dimension': 2,
 'method_name': 'dynamics_aware_pd_rule',
 'strategy': 'dynamics_pd',
