...
class PolicyClass(MaxSpaceRulePolicy):
    """Stable adapter for max_space_s09_rule_v1 (S09)."""

    PACKAGE_SPEC = {'policy_id': 'max_space_s09_rule_v1',
 'scenario_id': 'S09',
 'dimension': 3,
 ...
 'primary_metric': 'synchronized_arrival_rate',
 ...
 'default_config': {'strategy': 'dynamics_pd',
                    'policy_id': 'max_space_s09_rule_v1',
                    'gain': 1.0,
                    'damping': 0.45,
                    'action_cap': 1.0,
                    'rate_limit': 2.0,
...
POLICY_SPEC = {'policy_id': 'max_space_s09_rule_v1',
 'scenario_id': 'S09',
 'dimension': 3,
 'method_name': 'dynamics_aware_pd_rule',
 'strategy': 'dynamics_pd',
