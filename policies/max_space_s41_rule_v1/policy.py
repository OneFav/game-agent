...
class PolicyClass(MaxSpaceRulePolicy):
    """Stable adapter for max_space_s41_rule_v1 (S41)."""

    PACKAGE_SPEC = {'policy_id': 'max_space_s41_rule_v1',
 'scenario_id': 'S41',
 'dimension': 2,
 ...
 'primary_metric': 'dynamic_team_coverage_rate',
 ...
 'default_config': {'strategy': 'lifecycle_role',
                    'policy_id': 'max_space_s41_rule_v1',
                    'gain': 1.0,
                    'damping': 0.55,
                    'action_cap': 1.0,
                    'rate_limit': 2.0,
...
POLICY_SPEC = {'policy_id': 'max_space_s41_rule_v1',
 'scenario_id': 'S41',
 'dimension': 2,
 'method_name': 'lifecycle_role_rule',
 'strategy': 'lifecycle_role',
