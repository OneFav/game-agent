...
class PolicyClass(MaxSpaceRulePolicy):
    """Stable adapter for max_space_s17_rule_v1 (S17)."""

    PACKAGE_SPEC = {'policy_id': 'max_space_s17_rule_v1',
 'scenario_id': 'S17',
 'dimension': 2,
 'method_name': 'decentralized_team_rule',
 'strategy': 'team_coordination',
 'controller_family': 'team_coordination',
 'task_family': 'team_cooperation',
 'primary_metric': 'formation_transition_success_rate',
 'observation_type': 'vector',
 'action_type': 'continuous',
 'agent_count': 5,
 'adversarial': False,
 'zero_policy': False,
 'default_config': {'strategy': 'team_coordination',
                    'policy_id': 'max_space_s17_rule_v1',
                    'gain': 1.0,
                    'damping': 0.55,
                    'action_cap': 1.0,
                    'rate_limit': 2.0,
                    ...
                    'role_gain': 0.0},
 'checkpoint_binding': {'method': 'decentralized_team_rule',
...
POLICY_SPEC = {'policy_id': 'max_space_s17_rule_v1',
 'scenario_id': 'S17',
 'dimension': 2,
 'method_name': 'decentralized_team_rule',
 'strategy': 'team_coordination',
