...
class PolicyClass(MaxSpaceRulePolicy):
    """Stable adapter for max_space_s28_rule_v1 (S28)."""

    PACKAGE_SPEC = {'policy_id': 'max_space_s28_rule_v1',
 'scenario_id': 'S28',
 'dimension': 3,
 ...
 'primary_metric': 'safe_landing_rate_under_sensor_noise',
 ...
 'default_config': {'strategy': 'observation_limited',
                    'policy_id': 'max_space_s28_rule_v1',
                    'gain': 1.0,
                    'damping': 0.55,
                    'action_cap': 0.82,
                    'rate_limit': 2.0,
...
POLICY_SPEC = {'policy_id': 'max_space_s28_rule_v1',
 'scenario_id': 'S28',
 'dimension': 3,
 'method_name': 'observation_limited_rule',
 'strategy': 'observation_limited',
