...
class PolicyClass(MaxSpaceRulePolicy):
    """Stable adapter for max_space_s47_rule_v1 (S47)."""

    PACKAGE_SPEC = {'policy_id': 'max_space_s47_rule_v1',
 'scenario_id': 'S47',
 'dimension': 2,
 ...
 'primary_metric': 'large_swarm_shape_success_rate',
 ...
 'default_config': {'strategy': 'scalable_adapter',
                    'policy_id': 'max_space_s47_rule_v1',
                    'gain': 1.0,
                    'damping': 0.55,
                    'action_cap': 0.92,
                    'rate_limit': 2.0,
...
POLICY_SPEC = {'policy_id': 'max_space_s47_rule_v1',
 'scenario_id': 'S47',
 'dimension': 2,
 'method_name': 'scalable_modality_rule',
 'strategy': 'scalable_adapter',
