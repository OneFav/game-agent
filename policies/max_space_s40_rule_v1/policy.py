...
class PolicyClass(MaxSpaceRulePolicy):
    """Stable adapter for max_space_s40_rule_v1 (S40)."""

    PACKAGE_SPEC = {'policy_id': 'max_space_s40_rule_v1',
 'scenario_id': 'S40',
 'dimension': 2,
 ...
 'primary_metric': 'ood_success_rate',
 ...
 'default_config': {'strategy': 'robust_capped',
                    'policy_id': 'max_space_s40_rule_v1',
                    'gain': 1.0,
                    'damping': 0.55,
                    'action_cap': 0.88,
                    'rate_limit': 2.0,
...
POLICY_SPEC = {'policy_id': 'max_space_s40_rule_v1',
 'scenario_id': 'S40',
 'dimension': 2,
 'method_name': 'robust_capped_pd_rule',
 'strategy': 'robust_capped',
