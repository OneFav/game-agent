...
class PolicyClass(MaxSpaceRulePolicy):
    """Stable adapter for max_space_s36_rule_v1 (S36)."""

    PACKAGE_SPEC = {'policy_id': 'max_space_s36_rule_v1',
 'scenario_id': 'S36',
 'dimension': 2,
 'method_name': 'robust_capped_pd_rule',
 'strategy': 'robust_capped',
 'controller_family': 'robustness_capped_pd',
 'task_family': 'robustness',
 'primary_metric': 'capture_rate_across_spawn_distribution',
 'observation_type': 'vector',
 'action_type': 'continuous',
 'agent_count': 2,
 'adversarial': False,
 'zero_policy': False,
 'default_config': {'strategy': 'robust_capped',
                    'policy_id': 'max_space_s36_rule_v1',
                    'gain': 1.0,
                    'damping': 0.55,
                    'action_cap': 0.88,
                    'rate_limit': 2.0,
                    ...
                    'role_gain': 0.0},
 'checkpoint_binding': {'method': 'robust_capped_pd_rule',
...
POLICY_SPEC = {'policy_id': 'max_space_s36_rule_v1',
 'scenario_id': 'S36',
 'dimension': 2,
 'method_name': 'robust_capped_pd_rule',
 'strategy': 'robust_capped',
