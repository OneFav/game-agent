...
class PolicyClass(MaxSpaceRulePolicy):
    """Stable adapter for max_space_s20_rule_v1 (S20)."""

    PACKAGE_SPEC = {'policy_id': 'max_space_s20_rule_v1',
 'scenario_id': 'S20',
 'dimension': 3,
 ...
 'primary_metric': 'team_ordered_gate_completion_rate',
 ...
 'default_config': {'strategy': 'team_coordination',
                    'policy_id': 'max_space_s20_rule_v1',
                    'gain': 1.0,
                    'damping': 0.55,
                    'action_cap': 1.0,
                    'rate_limit': 2.0,
...
POLICY_SPEC = {'policy_id': 'max_space_s20_rule_v1',
 'scenario_id': 'S20',
 'dimension': 3,
 'method_name': 'decentralized_team_rule',
 'strategy': 'team_coordination',
