...
class PolicyClass(MaxSpaceRulePolicy):
    """Stable adapter for max_space_s10_rule_v1 (S10)."""

    PACKAGE_SPEC = {'policy_id': 'max_space_s10_rule_v1',
 'scenario_id': 'S10',
 'dimension': 3,
 'method_name': 'dynamics_aware_pd_rule',
 'strategy': 'dynamics_pd',
 'controller_family': 'dynamics_aware_pd',
 'task_family': 'dynamics',
 'primary_metric': 'flight_envelope_completion_rate',
 'observation_type': 'vector',
 'action_type': 'continuous',
 'agent_count': 1,
 'adversarial': False,
 'zero_policy': False,
 'default_config': {'strategy': 'dynamics_pd',
                    'policy_id': 'max_space_s10_rule_v1',
                    'gain': 1.0,
                    'damping': 0.45,
                    'action_cap': 1.0,
                    'rate_limit': 2.0,
                    ...
                    'role_gain': 0.0},
 'checkpoint_binding': {'method': 'dynamics_aware_pd_rule',
...
POLICY_SPEC = {'policy_id': 'max_space_s10_rule_v1',
 'scenario_id': 'S10',
 'dimension': 3,
 'method_name': 'dynamics_aware_pd_rule',
 'strategy': 'dynamics_pd',
