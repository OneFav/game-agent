...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Prepare a checkpoint for the slalom_1v1_3d rule policy.")
...
def main() -> int:
    ...
    try:
        ...
        (output_dir / "checkpoint.json").write_text(json.dumps(checkpoint, indent=2, ensure_ascii=False), encoding="utf-8")
        return 0
    except MemoryError:
        return 3
